...
This project was developed using a Hybrid Engineering Workflow, combining modern AI-assisted scripting with manual hardware-in-the-loop (HIL) calibration:

    AI-Accelerated Scripting: I utilized Large Language Models (LLMs) to generate robust boilerplate code and handle complex library integrations (e.g., Arduino_LSM6DSOX.h and Servo.h). This allowed me to reduce the development cycle and focus on system architecture rather than syntax.
